...
const socialIcons = (connect:any) =>{
    switch(connect.name.toLowerCase()){ 
        ...
        case "linkdin/tapanmp": return <div><a className="flex items-center" href={connect.link} target="_blank"><span className="mr-3"><AiFillLinkedin /></span>{ connect.name }</a></div>
