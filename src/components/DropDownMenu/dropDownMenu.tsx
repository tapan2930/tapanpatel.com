...
const DropDownMenu = ({OnChangeThemeHandler}:any) => {
  ...
  return (
    <div className="relative cursor-pointer outline-none hover:outline-none noSelect" onClick={()=>{setTogglePanel(!togglePanel)}}>
        ...
        {
            togglePanel && (
                <div className="absolute bg-tertiary border-secondary border shadow-2xl frost  w-32 -right-12 sm:-right-10 top-12 sm:top-16  rounded-md  outline-none hover:outline-none">
